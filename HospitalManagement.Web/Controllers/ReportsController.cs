...
public class ReportsController:Controller
{
    ...
    public ReportsController(HospitalApiService api)=>this.api=api;
    [HttpGet]
    public IActionResult Index()=>View();
    [HttpPost]
    [IgnoreAntiforgeryToken]
    public async Task<IActionResult>Summary([FromBody]ReportRequest request)
    {
        var r=await api.ReportAsync(request.From,request.To);
